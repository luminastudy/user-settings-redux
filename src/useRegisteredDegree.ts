...
export interface UseRegisteredDegreeReturn {
  ...
  setRegisteredDegree: (degreeId: string | null, institutionId: string | null, degreeTitle?: string) => void;
...
export function useRegisteredDegree(): UseRegisteredDegreeReturn {
  ...
  const [registeredDegree, setRegisteredDegreeState] = useState<RegisteredDegreeData>(() => {
  ...
  const setRegisteredDegree = useCallback(
    (degreeId: string | null, institutionId: string | null, degreeTitle?: string) => {
      setIsUpdating(true);
      try {
        const newData: RegisteredDegreeData = { degreeId, institutionId, degreeTitle };
  ...
  const clearRegisteredDegree = useCallback(() => {
    setIsUpdating(true);
    try {
      const emptyData: RegisteredDegreeData = { degreeId: null, institutionId: null };
  ...
  const isDegreeRegistered = useCallback((degreeId: string): boolean => {
